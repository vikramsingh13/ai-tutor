  ...
  return (
    <div className="flex flex-col p-4 text-center h-full">
      ...
      <div className="flex flex-1 flex-row py-4 justify-between">
        <Button disabled={quizQuestionIndex === 0} onClick={handleQuizSectionNavigationButtonClick} navigation={SectionNavigationButtonTypes.PREV}>Prev</Button>
        ...
        <Button disabled={quizQuestionIndex + 1 >= Object.keys(quizData).length} onClick={handleQuizSectionNavigationButtonClick} navigation={SectionNavigationButtonTypes.NEXT}>Next</Button>
      </div>
    </div>
  );
};
